...
from multiagent.rendering import all_data1
import argparse
import time
if __name__ == '__main__':
  ...
  #with PyCallGraph(output=graphviz):
    ...
    if MOD == "ppo vs mbam":
        ...
        player1_file = file_dir + "PPO_MH_player1__player1_iter120700.ckp"
        player2_file = file_dir + "PPO_MH_player2_player2_iter120700.ckp"
        #
        ...
        for i in range(100):
            ...
            while True:
                ...
                #all_data.update_hangcheng(list=dis)
                #print(rew)
                #if rew[0] >= 10:
                #    print("touch!!!!!!!")
                s = s_
