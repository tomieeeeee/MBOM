...
from env_wapper.simple_tag.simple_tag_origin import Simple_Tag
import argparse
import time
if __name__ == '__main__':
  ...
  #with PyCallGraph(output=graphviz):
    ...
    if MOD == "ppo vs mbam":
        ...
        player1_file = file_dir + "PPO_MH_player1_rank0_iter1000.ckp"
        player2_file = file_dir + "MBAM_player2_iter1000.ckp"
