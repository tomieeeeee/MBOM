...
hidden_layer1 = 64
hidden_layer2 = 32
path = get_exp_data_path() + "/Simple_Tag/Env_Model/ENV_simple_tag_new"
reward_normal_factor = 10
# 24+11+11->24+1
class ENV_Simple_Tag(nn.Module):
    def __init__(self, args):
        super(ENV_Simple_Tag, self).__init__()
        self.l1 = nn.Linear(n_state + n_action + sum(n_oppo_action), hidden_layer1)
...
def train(args):
    ...
    optimizer = torch.optim.SGD(env_model.parameters(), lr=0.001)
    loss_fn = nn.MSELoss()
